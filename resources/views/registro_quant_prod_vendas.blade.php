...
<head>
    ...
    <title>REGISTRO DE PRODUTOS A VENDA</title>
...
<body>
    ...
    <div class="row">
        <div class="">
            <h5 class="white-text center orange"><b>REGISTRO DE PRODUTOS A SER VENDIDOS</b></h5>
            <table class="responsive-table centered highlight" style="background: rgba(0,0,0,0.6);">
                ...
                <tbody class="grey-text" style="font-size: 20px;">
                    ...
                    <tr>
                        ...
                        <td><img src="/foto_produtos/{{ $produto->foto_produto }}" width="100px" height="50px" alt=""></td>
                        <td>
                            <a href="{{ route('form_registro_prod_venda',['id_produtos' =>$produto->id_produtos]) }}" title="Registrar" class="btn btb-floating green waves-effect">
